...
[h: saveDamage = dnd5e_RollExpression_setSaveEffectMultiplier (saveDamage, "0.5")]
[h: saveDamage = dnd5e_RollExpression_setSaveEffect (saveDamage, "half")]
[h: rollExpressions = json.append ("", attackExpression, regularDamage, saveDamage)]
[h: log.debug (getMacroName() + ": rollExpressions = " + json.indent (rollExpressions))]
...
[h: resultObj = json.set ("", getMacroName(), results)]
