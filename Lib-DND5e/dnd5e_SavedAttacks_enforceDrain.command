...
[h, if (saveText != ""): saveText = "Adjusted(" + saveText + ")"]
[h, if (drain != dnd5e_RollExpression_getTotal(exp)): tt = tt + ", saveText + ": " + drain]
...
[h: player = json.append(player, strformat("Drain %{ability} %{drain}%{saveText}"))]
