[h: effectsMap = json.set ("", "_blind", "Can't see; fails checks requiring sight",
					...
					"_deaf", "Can't hear; fails checks requiring hearing",
					...
					"_invisible", "Can't be seen normally",
					...
					"_dmgResist", "Resistance to all damage",
					"_poisonImmunity", "Immune to poison, disease",
					"abilityDis", "Ability checks have disadvantage",
					"_closeAdvFarDis", "Attacker has adv melee, disadv ranged",
